...
<html>
    ...
    <body>
        <div class="x-body">
            <form id="form" class="layui-form layui-form-pane" method="post" action="{{url('admin/news/edit/' . ($res->id))}}">
                {{csrf_field()}}
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        autocomplete="off" class="layui-input" value="{{empty($res) ? null : $res->title}}">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" id="url" name="url" required="" lay-verify="required"
                               autocomplete="off" placeholder="http://" class="layui-input" value="{{empty($res) ? null : $res->url}}">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="L_title" class="layui-form-label">
                    ...
                    <div class="layui-input-block">
                        <input type="text" id="L_title" name="author" required lay-verify="title"
                               autocomplete="off" class="layui-input" value="{{empty($res) ? null : $res->author}}">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    <label  class="layui-form-label">头像缩略图
                        ...
                        <img id="LAY_demo_upload" width="100" src="{{empty($res->smallimg) ? null : $res->smallimg}}">
                </div>
                <div class="layui-form-item layui-form-text">
                    <div class="layui-input-block" style="border: 0px solid red;">
                        <textarea id="L_content" name="description"
                        placeholder="请输入内容" class="layui-textarea">{{empty($res) ? null : $res->description}}</textarea>
                    </div>
